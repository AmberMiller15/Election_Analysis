...
with open(file_to_save, 'w') as txt_file:
    ...
    # Determine the percentage fo votes for each candidate by looping throught the counts
    ...
    for candidate_name in candidate_votes:
        ...
        # Print out each candidate's name, their voter count, and percentage to the 
        # terminal
    ...
    winning_candidate_summary =(
        ...
        f"Winning Percenatage : {winning_percentage:.1f}%\n"
        f"-----------------------\n")

    # Print the winning candidate's name to the terminal. 
